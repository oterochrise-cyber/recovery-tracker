...
const QUOTES = [
  { t: "My life gets better when I put my energy back into it.", g: ["wk10", "morning", "afternoon", "generic"] },
  { t: "I have too much ahead of me to live facing backward.", g: ["wk10", "morning", "generic"] },
  { t: "Today deserves my full attention.", g: ["wk10", "morning", "generic"] },
  { t: "I am building a life I am excited to wake up to.", g: ["wk10", "morning", "evening", "generic"] },
  { t: "My future gets my effort, not my fear.", g: ["wk10", "morning", "afternoon", "generic"] },
  { t: "I do not need perfect conditions to have a great day.", g: ["wk10", "morning", "red", "generic"] },
  { t: "One good decision can change the direction of an entire day.", g: ["wk10", "morning", "afternoon", "red"] },
  { t: "I keep moving even when my emotions are catching up.", g: ["wk10", "afternoon", "red", "generic"] },
  { t: "Momentum is built by what I do next.", g: ["wk10", "afternoon", "generic"] },
  { t: "I am becoming harder to knock off course.", g: ["wk10", "morning", "milestone", "generic"] },
  { t: "The goal is not perfection. The goal is forward.", g: ["wk10", "morning", "afternoon", "postslip", "generic"] },
  { t: "I know who I am even when life feels uncertain.", g: ["wk10", "morning", "red", "generic"] },
  { t: "I do not need outside validation to recognize my own value.", g: ["wk10", "afternoon", "evening", "generic"] },
  { t: "I am proud of the man I am becoming.", g: ["wk10", "morning", "evening", "milestone"] },
  { t: "My character matters more than anyone's opinion of me.", g: ["wk10", "afternoon", "generic"] },
  { t: "I can look in the mirror and respect the person looking back.", g: ["wk10", "morning", "evening", "generic"] },
  { t: "I am no longer building my identity around what I lost.", g: ["wk10", "evening", "night", "generic"] },
  { t: "I found another door by refusing to stop walking.", g: ["wk10", "morning", "milestone", "generic"] },
  { t: "The route changed and somehow I leveled up.", g: ["wk10", "morning", "milestone"] },
  { t: "I can pivot without calling myself a failure.", g: ["wk10", "morning", "red", "milestone"] },
  { t: "What looked like a step backward created room for something better.", s: "A step backward made room for something better.", g: ["wk10", "morning", "milestone", "generic"] },
  { t: "I trust myself to figure out the next move.", g: ["wk10", "morning", "afternoon", "generic"] },
  { t: "I do not need the whole map to take the next step.", g: ["wk10", "morning", "evening", "generic"] },
  { t: "My life is bigger than the thing that hurt me.", g: ["wk10", "morning", "evening", "red", "generic"] },
  { t: "I have more to be grateful for than my mind remembers when it hurts.", s: "I have more to be grateful for than I remember when it hurts.", g: ["wk10", "evening", "red"] },
  { t: "I already have a life worth protecting and enjoying.", g: ["wk10", "afternoon", "evening", "generic"] },
  { t: "There is so much happening around me when I remember to look.", g: ["wk10", "afternoon", "evening", "generic"] },
  { t: "I am allowed to enjoy what I have while still wanting more.", g: ["wk10", "evening", "generic"] },
  { t: "Nothing missing gets to erase everything present.", g: ["wk10", "evening", "night", "red", "generic"] },
  { t: "Taking care of myself is part of who I am now.", g: ["wk10", "morning", "generic"] },
  { t: "I train because I love what my body is capable of.", g: ["wk10", "morning", "afternoon", "generic"] },
  { t: "I want to see how healthy, strong, and disciplined I can become.", g: ["wk10", "morning", "generic"] },
  { t: "I can push myself without punishing myself.", g: ["wk10", "morning", "afternoon", "generic"] },
  { t: "Every workout is another vote for the life I want.", g: ["wk10", "morning", "afternoon", "generic"] },
  { t: "My body deserves the same commitment I give my work.", g: ["wk10", "morning", "generic"] },
  { t: "God has the outcome. I have today.", g: ["wk10", "morning", "night", "generic"] },
  { t: "I can walk into uncertainty without fear deciding the direction.", g: ["wk10", "morning", "evening", "generic"] },
  { t: "I do not need to know what is coming to believe something good is ahead.", s: "I don't need to know what's coming to believe it's good.", g: ["wk10", "morning", "evening", "generic"] },
  { t: "Peace is enough for today.", g: ["wk10", "morning", "night", "generic"] },
  { t: "I can surrender the future without surrendering my ambition.", g: ["wk10", "morning", "evening", "milestone"] },
  { t: "I feel ready for whatever this next chapter asks of me.", g: ["wk10", "morning", "evening", "milestone"] },
  { t: "I will not treat a blank as evidence.", g: ["wk9", "wk10", "morning", "afternoon", "risk", "heldline"] },
  { t: "I do not need to turn missing information into bad news.", g: ["wk9", "morning", "afternoon", "risk", "red"] },
  { t: "My fear can fill a blank without telling me the truth.", g: ["wk9", "afternoon", "evening", "risk", "red"] },
  { t: "I have felt certain before and still been missing context.", g: ["wk9", "afternoon", "evening", "risk", "red"] },
  { t: "The story in my head is not new information.", g: ["wk9", "wk10", "morning", "afternoon", "risk", "red"] },
  { t: "I can leave an unknown unanswered and keep my day.", g: ["wk9", "morning", "afternoon", "heldline"] },
  { t: "Time passing is not evidence that my fear is happening.", g: ["wk9", "morning", "night", "risk", "red"] },
  { t: "I can change the route without abandoning what matters.", g: ["wk9", "morning", "milestone", "generic"] },
  { t: "Being late by my schedule does not mean I am lost.", g: ["wk9", "morning", "red", "milestone"] },
  { t: "I can reroute without calling the journey a failure.", g: ["wk9", "morning", "afternoon", "milestone", "generic"] },
  { t: "A red light can be a pause, not a punishment.", g: ["wk9", "afternoon", "red", "milestone"] },
  { t: "God can use a route I never would have chosen.", g: ["wk9", "morning", "evening", "night", "generic"] },
  { t: "I can choose the room that protects my peace.", g: ["wk9", "morning", "afternoon", "risk"] },
  { t: "Staying with my plan is choosing myself.", g: ["wk9", "morning", "afternoon", "heldline"] },
  { t: "My day does not have to follow her location.", g: ["wk9", "wk10", "afternoon", "risk", "heldline"] },
  { t: "I can let one place be hers and still enjoy mine.", g: ["wk9", "heldline", "risk"] },
  { t: "I will not turn today into a waiting room.", g: ["wk9", "morning", "red", "generic"] },
  { t: "The peace does not owe me a timeline.", g: ["wk9", "morning", "night", "red", "generic"] },
  { t: "I can stop watching the clock and keep living.", g: ["wk9", "morning", "afternoon", "generic"] },
  { t: "My timeline is not the measure of what God is doing.", g: ["wk9", "morning", "evening", "night", "red"] },
  { t: "She already knows. I do not need to repeat myself.", g: ["wk9", "wk10", "afternoon", "evening", "heldline", "risk"] },
  { t: "If the change is real, I do not need to announce it.", g: ["wk9", "morning", "afternoon", "heldline", "milestone"] },
  { t: "I can let one good interaction end while it is still good.", g: ["wk9", "evening", "heldline", "risk"] },
  { t: "Small moments stay safe when I do not ask them to become more.", g: ["wk9", "afternoon", "evening", "heldline", "risk"] },
  { t: "I can care without creating another opening.", g: ["wk9", "afternoon", "evening", "heldline", "risk"] },
  { t: "I am allowed to grieve without investigating.", g: ["wk9", "wk10", "morning", "evening", "night", "risk"] },
  { t: "More information is not the same as more peace.", g: ["wk9", "afternoon", "evening", "risk", "red"] },
  { t: "The urge to ask is not the answer I need.", g: ["wk9", "wk10", "afternoon", "heldline", "risk"] },
  { t: "I can feel the loss without turning it into a case.", g: ["wk9", "evening", "night", "red", "risk"] },
  { t: "Checking gives me a task, not relief.", g: ["wk9", "wk10", "afternoon", "evening", "heldline", "risk"] },
  { t: "I was trying to move the pain, not reach her.", g: ["wk9", "night", "postslip", "red"] },
  { t: "A slip does not erase the restraint that came before it.", g: ["wk9", "wk10", "morning", "postslip", "red"] },
  { t: "I can repair the next choice without punishing the last one.", g: ["wk9", "wk10", "morning", "postslip", "red"] },
  { t: "Calling did not answer the wound underneath.", g: ["wk9", "night", "postslip", "red"] },
  { t: "My life can stand while the outcome stays unknown.", g: ["wk9", "morning", "red", "generic"] },
  { t: "My ability to function cannot depend on one person returning.", g: ["wk9", "morning", "red", "risk", "heldline"] },
  { t: "My worth stays mine while the outcome stays unknown.", g: ["wk9", "morning", "evening", "red", "generic"] },
  { t: "I am still a whole person inside an unfinished story.", g: ["wk9", "morning", "night", "red", "generic"] },
  { t: "I can love her without making her return my foundation.", g: ["wk9", "morning", "evening", "heldline", "red"] },
  { t: "I contribute more when the work is chosen, not forced.", g: ["wk9", "morning", "milestone", "generic"] },
  { t: "I did not lose my place. I found a better lane.", g: ["wk9", "morning", "milestone", "red"] },
  { t: "The title changed. My impact did not.", g: ["wk9", "morning", "milestone", "generic"] },
  ...
  { t: "Consistency is how I act when I don't get the response I wanted.", g: ["wk7", "wk9", "afternoon", "heldline", "generic"] },
  { t: "I can let a good moment be good without making it answer the future.", s: "A good moment can be good without answering the future.", g: ["wk7", "wk9", "evening", "afternoon", "generic"] },
  { t: "Yesterday was good. I do not need to know what happened after I left for it to remain good.", s: "Yesterday was good. I don't need to know what came after.", g: ["wk7", "morning", "risk", "generic"] },
  { t: "I can miss the life I expected and still build the life in front of me.", s: "I can miss the life I expected and still build this one.", g: ["wk7", "evening", "night", "generic"] },
  { t: "What almost broke me can become wisdom I give to someone else.", g: ["wk7", "afternoon", "generic"] },
  { t: "I can care deeply without going into rescue mode.", g: ["wk7", "wk9", "afternoon", "risk", "generic"] },
  { t: "Small consistent actions include knowing when to give space.", g: ["wk7", "wk9", "afternoon", "heldline", "generic"] },
  ...
  { t: "The peace came before the answer.", g: ["wk6", "wk7", "wk9", "morning", "afternoon", "evening", "night", "generic"] },
  { t: "Surrender did not close my heart; it released my grip.", g: ["wk6", "wk7", "morning", "evening", "generic"] },
  { t: "I can keep my heart open without keeping my hands on the outcome.", s: "Heart open. Hands off the outcome.", g: ["wk6", "wk7", "wk9", "morning", "afternoon", "evening", "generic"] },
  ...
  { t: "The day can hurt without being a bad day.", g: ["wk6", "wk7", "wk9", "evening", "night", "generic"] },
  { t: "Grief and peace can exist in the same body.", g: ["wk6", "wk7", "wk9", "evening", "generic"] },
  { t: "This is a wave, not a verdict.", g: ["wk6", "wk7", "wk9", "wk10", "morning", "red", "risk", "postslip", "generic"] },
  { t: "My nervous system can be loud without being right.", g: ["wk6", "wk7", "wk9", "wk10", "morning", "afternoon", "red", "risk", "generic"] },
  { t: "A missing reassurance is not negative information.", g: ["wk6", "wk7", "wk9", "afternoon", "risk", "heldline", "generic"] },
  ...
  { t: "I can miss her without losing myself.", g: ["wk6", "wk7", "wk9", "evening", "night", "generic"] },
  ...
  { t: "The pain came back. I did not go backward.", g: ["wk6", "wk7", "wk5", "wk9", "wk10", "postslip", "morning", "milestone", "generic"] },
  { t: "Healing is not feeling less. It is responding differently.", g: ["wk6", "wk7", "wk5", "wk9", "wk10", "morning", "evening", "milestone", "generic"] },
  { t: "I saw her, felt everything, and kept walking.", g: ["wk5", "heldline", "milestone"] },
  { t: "I am not waiting to feel better before I live better.", g: ["wk6", "wk7", "wk5", "wk9", "wk10", "morning", "afternoon", "generic"] },
  ...
  { t: "An unanswered question is not an emergency.", g: ["wk5", "wk9", "afternoon", "risk"] },
  ...
  { t: "I can calm down before I know.", g: ["wk6", "wk7", "wk4", "wk5", "wk9", "wk10", "morning", "afternoon", "evening", "night", "risk", "red", "heldline", "generic"] },
  ...
  { t: "I can hold hope without putting my life on hold.", g: ["wk6", "wk7", "wk4", "wk5", "wk9", "morning", "evening", "generic"] },
  ...
  { t: "My first thought does not decide my day.", g: ["wk6", "wk7", "wk4", "wk5", "wk9", "wk10", "morning", "red"] },
  { t: "Dreams are processing, not prophecy.", g: ["wk6", "wk7", "wk9", "night", "wk4", "wk5", "morning", "red"] },
  { t: "Good sleep still counts when the dreams are hard.", g: ["wk4", "morning"] },
  { t: "Start with God. Stay with today.", g: ["wk4", "morning", "generic"] },
  { t: "I wake up to build, not investigate.", g: ["wk6", "wk7", "wk4", "wk5", "wk9", "wk10", "morning", "risk"] },
  ...
  { t: "What am I telling myself? What do I need? How do I change course early?", s: "What am I telling myself? What do I need? Course-correct early.", g: ["wk4","wk5", "risk", "red"] },
  ...
  { t: "I release what I cannot control and invest in what I can.", g: ["wk6", "wk7", "wk3", "wk9", "wk10", "morning", "generic"] },
...
function packFor(today) { // weekly packs exist for wks 3–13; any other week rotates the full bank
  if (!today) return null;
  const w = Math.floor((Date.parse(today + "T12:00:00Z") - Date.parse(START_DATE + "T12:00:00Z")) / 864e5 / 7) + 1;
  return w === 3 ? "wk3" : w === 4 ? "wk4" : w === 5 ? "wk5" : w === 6 ? "wk6" : w === 7 ? "wk7" : (w === 8 || w === 9 || w === 10) ? "wk9" : (w === 11 || w === 12 || w === 13) ? "wk10" : null;
}
