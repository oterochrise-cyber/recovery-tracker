...
const QUOTES = [
  ...
  { t: "I can calm down before I know.", g: ["wk4", "morning", "afternoon", "evening", "night", "risk", "red", "heldline", "generic"] },
  { t: "Trust the evidence, not the adrenaline.", g: ["wk4", "afternoon", "evening", "risk", "red", "generic"] },
  { t: "My body is asking for safety, not information.", g: ["wk4", "afternoon", "night", "risk", "red", "generic"] },
  { t: "I am becoming the man I need and want to be.", g: ["wk4", "morning", "evening", "milestone", "generic"] },
  { t: "I can hold hope without putting my life on hold.", g: ["wk4", "morning", "evening", "generic"] },
  { t: "I do not need every detail to trust God.", g: ["wk4", "evening", "night", "risk", "generic"] },
  { t: "Today is mine before it belongs to any memory.", g: ["wk4", "morning"] },
  { t: "My first thought does not decide my day.", g: ["wk4", "morning", "red"] },
  { t: "Dreams are processing, not prophecy.", g: ["wk4", "morning", "red"] },
  { t: "Good sleep still counts when the dreams are hard.", g: ["wk4", "morning"] },
  { t: "Start with God. Stay with today.", g: ["wk4", "morning", "generic"] },
  { t: "I wake up to build, not investigate.", g: ["wk4", "morning", "risk"] },
  { t: "One day at a time is enough.", g: ["wk4", "morning", "generic"] },
  { t: "No update is an emergency.", g: ["wk4", "afternoon", "risk"] },
  { t: "I can see what triggers me and stay with myself.", g: ["wk4", "afternoon", "risk"] },
  { t: "Another person's presence can spike me without controlling me.", g: ["wk4", "afternoon", "risk"] },
  { t: "A glance is not a message.", g: ["wk4", "afternoon", "risk"] },
  { t: "A hello can be only a hello.", g: ["wk4", "afternoon"] },
  { t: "I can let neutral be neutral.", g: ["wk4", "afternoon", "generic"] },
  { t: "I do not need to interpret someone else to regulate myself.", g: ["wk4", "afternoon", "risk"] },
  { t: "The office is shared space; my focus is still mine.", g: ["wk4", "afternoon"] },
  { t: "Another person's schedule is not my assignment.", g: ["wk4", "afternoon", "risk"] },
  { t: "Unusual does not mean dangerous.", g: ["wk4", "afternoon", "risk", "red"] },
  { t: "The feeling is real. The story is still unproven.", g: ["wk4", "afternoon", "risk", "red", "generic"] },
  { t: "Slow day. Small task. Steady mind.", g: ["wk4", "afternoon", "red"] },
  { t: "The workday is over; the investigation is over.", g: ["wk4", "evening", "risk"] },
  { t: "Caring is not checking.", g: ["wk4", "evening", "risk", "generic"] },
  { t: "Checking is not connection.", g: ["wk4", "evening", "night", "risk"] },
  { t: "Reassurance fades. Self-trust stays.", g: ["wk4", "evening", "generic"] },
  ...
  { t: "Tonight is for living, not decoding.", g: ["wk4", "evening", "night"] },
  { t: "Tomorrow does not need tonight's analysis.", g: ["wk4", "night"] },
  { t: "No checking after dark.", g: ["wk4", "night", "risk"] },
  { t: "Rest is part of recovery.", g: ["wk4", "night", "red"] },
  { t: "My mind can revisit the past; I do not have to follow.", g: ["wk4", "night"] },
  { t: "God can work while I rest.", g: ["wk4", "night", "generic"] },
  { t: "I leave the outcome with God and keep becoming.", g: ["wk4", "night", "generic"] },
  { t: "This weekend is mine to live.", g: ["wk4", "weekend", "morning"] },
  { t: "The last hard weekend does not own this one.", g: ["wk4", "weekend", "morning"] },
  { t: "I can build new memories without erasing old ones.", g: ["wk4", "weekend", "afternoon"] },
  { t: "I am allowed to enjoy today without betraying what I felt.", g: ["wk4", "weekend", "afternoon"] },
  { t: "One good weekend proved I can build another.", g: ["wk4", "weekend", "morning", "milestone"] },
  { t: "I do not have to spend the weekend waiting.", g: ["wk4", "weekend", "evening"] },
  { t: "This is a trigger, not a trap.", g: ["wk4", "risk", "red"] },
  { t: "Pause before the story becomes a crisis.", g: ["wk4", "risk", "red"] },
  { t: "What am I telling myself? What do I need? How do I change course early?", g: ["wk4", "risk", "red"] },
  { t: "Nothing bad has been confirmed.", g: ["wk4", "risk", "red"] },
  { t: "My growth does not need an audience.", g: ["wk4", "heldline"] },
  { t: "Respecting space is strength, not surrender.", g: ["wk4", "heldline"] },
  { t: "I don't have to tell her I understand; I can show it.", g: ["wk4", "heldline"] },
  { t: "I can care without reaching.", g: ["wk4", "heldline"] },
  { t: "Every update I do not seek strengthens self-trust.", g: ["wk4", "heldline"] },
  { t: "One calm choice changes the pattern.", g: ["wk4", "heldline"] },
  { t: "The urge will peak and pass.", g: ["wk4", "heldline"] },
  { t: "One check is a slip, not a collapse.", g: ["wk4", "postslip"] },
  { t: "Stop here. The next choice still belongs to me.", g: ["wk4", "postslip"] },
  { t: "I do not punish myself; I change course.", g: ["wk4", "postslip"] },
  { t: "Progress resumes with the next action.", g: ["wk4", "postslip"] },
  { t: "Recovery is not never getting triggered; it is returning sooner.", g: ["wk4", "milestone"] },
  { t: "I calmed down before reassurance arrived.", g: ["wk4", "milestone", "heldline"] },
  { t: "My nervous system can learn.", g: ["wk4", "milestone", "red"] },
  { t: "I can be triggered and still have a great day.", g: ["wk4", "milestone", "postslip"] },
  { t: "I do not need to feel perfect to perform.", g: ["wk4", "milestone", "red"] },
  { t: "One good weekend changed what I believed was possible.", g: ["wk4", "milestone", "weekend"] },
  { t: "This is what becoming looks like.", g: ["wk4", "milestone"] },
  { t: "It is desire, not ability, that determines whether I hear God's voice.", g: ["wk4", "morning", "generic"] },
  { t: "My relationship with God is between me and God.", g: ["wk4", "evening", "generic"] },
  { t: "Don't expect to hear God while keeping my Bible closed.", g: ["wk4", "night", "morning"] },
  { t: "Nothing in life that matters happens in a hurry, so why assume we can hear God's voice in a hurry?", g: ["wk4", "evening", "generic"] },
  { t: "I do not have to force every door.", g: ["wk4", "afternoon", "night", "generic"] },
  { t: "I keep walking. God handles the timing.", g: ["wk4", "morning", "evening", "generic"] },
  ...
  { t: "My character is built by how I act while I'm hurting.", g: ["wk3", "wk4", "morning", "afternoon", "risk", "heldline", "postslip", "generic"] },
  ...
  { t: "Feel everything. Chase nothing.", g: ["wk3", "wk4", "evening", "night", "risk", "generic"] },
  { t: "Peace is built, not found.", g: ["wk3", "wk4", "morning", "generic"] },
  { t: "The strongest move today is self-control.", g: ["wk3", "wk4", "morning", "risk"] },
  { t: "I don't need answers to keep moving.", g: ["wk3", "wk4", "morning", "afternoon", "risk", "postslip", "generic"] },
  ...
  { t: "Recovery is measured in trends, not moments.", g: ["wk3", "wk4", "evening", "postslip", "milestone"] },
  ...
  { t: "Every moment of restraint strengthens the man I'm becoming.", g: ["wk3", "wk4", "evening", "night", "heldline", "risk", "generic"] },
  { t: "Calm is my advantage.", g: ["wk3", "wk4", "morning", "afternoon", "risk", "red", "generic"] },
  ...
  { t: "I was whole before this. I'll be whole after it.", g: ["wk3", "wk4", "morning", "evening", "postslip", "red", "generic"] },
  ...
  { t: "Control the controllable. Accept the rest.", g: ["wk3", "wk4", "morning", "afternoon", "risk", "red", "generic"] },
...
const PACK_ONLY = "wk4"; // week of Jul 28: "Calm before certainty" pack only — set to null to restore the full bank
